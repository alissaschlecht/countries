...
{/*          <Select
          ...
          <button onClick={() => createPNGFromSVGAndDownload('svg', this.state.imgSize, this.state.imgSize, 'samplefilename.png')} style={{backgroundColor: "lightgray"}}>download</button>
        </div>
      </div>
    );
  }
